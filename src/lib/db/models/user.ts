...
export interface Users extends Document, Iuser {}
...
// Use Model<Users> & UserModel to combine both the Mongoose model type and our custom interface
export const User = ((mongoose.models.User as Model<Users> & UserModel) ||
  mongoose.model<Users>("User", UserSchema)) as Model<Users> & UserModel;
