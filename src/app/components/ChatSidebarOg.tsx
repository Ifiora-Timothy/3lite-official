...
import WalletConnectModal from "./WalletConnectModel";
...
const ChatList: React.FC<ChatListProps> = ({ onChatSelect }) => {
  ...
  const getAllChats = async () => {
    ...
    try {
      ...
      console.log("Failed to fetch chats", user);
  ...
  let [renderedGroupChats, renderedPersonalChats] = getPersonalandGroupChats(
    currChats,
    searchQuery,
    searchResults,
    user
  ...
  // // Render wallet modal or main content
  // if (isModalOpen) {
