...
import { SolLogo } from "@/app/components/SolLogo";
import CustomIcon from "../ui/CustomIcon";
const MobileAuth = ({ children }: PropsWithChildren) => {
  return (
...
export const SuiLogo = ({ className }: { className?: string }) => {
  return (
    <svg
      id="Layer_1"
      x="0px"
      ...
      style={{ enableBackground: "new 0 0 300 383.5" } as React.CSSProperties}
    >
      <path
        style={{
          fillRule: "evenodd",
